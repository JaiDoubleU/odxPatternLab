    ...
    var openCaseView = function (theHref) {
        console.error('document location is ' + theHref);
        ...
        anomaliesTable = $('#anomaliesList').DataTable({
            ...
            "createdRow": function (row, data, dataIndex) {
                ...
                for (var index = 2; index < tableCells.length - 1; index++) {
                    ...
                    var caseViewUrl = document.getElementById('caseViewHref').value;
                    cell.style.cursor = "pointer";
                    cell.addEventListener("click", function() { openCaseView(caseViewUrl) });
                }
        ...
        $('#anomaliesList tbody').on('click', 'td.details-control', function () {
            ...
            if (domSelectedTicket) {
                ...
                $.each(mappedTickets, function (i, ticketData) {
                    ...
                    nextLine += "   <td class='text-center'><a><i class='far fa-external-link'></i></a></td>";
                    nextLine += "</tr>";
                });
