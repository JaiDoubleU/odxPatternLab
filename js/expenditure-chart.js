...
var expenditureGaugeHeight = 160;
$('#expenditureChart').ready(function () {
    function gaugeChart() {
            margin = {
                top: 45,
                right: 20,
    ...
    (function () {
        ...
        function resize() {
            var gWidth = Math.min(d3.select("#expenditureChart").node().offsetWidth, 260);
            gauge.width(gWidth).innerRadius(gWidth / 4).outerRadius((gWidth / 4) + 40);
            d3.select("#expenditureChart").call(gauge);
        }
