...
function populateStates(countryElementId, stateElementId) {
    ...
    var selectedCountry = country_arr[selectedCountryIndex -1];
    var stateProvinceLabel = document.getElementById('stateProvinceLabel');
    var zipPostalCodeLabel = document.getElementById('zipPostalCodeLabel');

    var nameOfStatesProvinces = 'State/Province';    
    var nameOfZipPostalCode = 'Zip/Postal Code';
    var zipPostalCodePlaceholder = "i.e. 99203";

    if(selectedCountry == 'USA') {
        nameOfStatesProvinces = 'State';
        nameOfZipPostalCode = 'Zip Code';
        zipPostalCodePlaceholder = "i.e. 98765-4321";
    } else if (selectedCountry == 'Canada'){
        nameOfStatesProvinces = 'Province';
        nameOfZipPostalCode = 'Postal Code';
        zipPostalCodePlaceholder = "i.e. T1E 4T5";
    } else {
        nameOfStatesProvinces = 'State/Province'
        nameOfZipPostalCode = 'Zip/Postal Code';
        zipPostalCodePlaceholder = 'i.e. 12345';
    }
    stateProvinceLabel.innerHTML = nameOfStatesProvinces;
    zipPostalCodeLabel.innerHTML = nameOfZipPostalCode;

    $('#zipPostalCodeInput').attr("placeholder", zipPostalCodePlaceholder);

    stateElement.length = 0; // Fixed by Julian Woods
    stateElement.options[0] = new Option('Select a ' +nameOfStatesProvinces, '');
